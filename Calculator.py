...
with kundenbestand_wert_col2_value:
    ...
    st.caption("Errechnet auf Basis der o.g. Werten und dem Jahresverkaufsziel (JVZ).")
...
## Creating the bar chart in an table
...
with kundenbestand_bar_col2_chart:
    ...
    st.bar_chart(data=data_peryear, x="Jahr", color=["#002B5E", "#00AAD2"])
